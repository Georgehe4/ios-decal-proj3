        ...
        let task = NSURLSession.sharedSession().dataTaskWithURL(url) {
            ...
            if error == nil {
                ...
                do {
                    ...
                    for photoInfo in jsonDictionary.valueForKey("data") as! NSArray {
                        if (photoInfo.valueForKey("type") as! String == "image") {
                            photos.append(Photo(data: photoInfo as! NSDictionary))
                        }
                    }
                    // DO NOT CHANGE BELOW
